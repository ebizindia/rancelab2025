...
<section id="hero" style="visibility: visible; animation-name: fadeIn;margin-top: ;">
  ...
  <section id="contact_us_section" class="about-us padd-section download-fusionretail text-center">
    <div class="container">
      <div class="row">
        <div class="col">
          <div class="about-content">           
            <p><a href="<?php echo CONST_APP_ABSURL;?>/downloads-fusionretail.php"><strong>Click here to start the download</p>
			</a>
			<p> In case of any assistance in downloading or installing, please feel free to call Ruma on <a href="tel:+919831926662">+91 98319 26662.</a></p>
