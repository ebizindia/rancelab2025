      ...
      <div class="row">
        <div class="col-md-8 col-lg-8">
          <div class="about-content"> 
			<p>You’re just a step away from experiencing a system that will streamline your business operations.</p>
			<p>We will shortly schedule a quick 30 mins online demo by a business expert.</p>
			<h4>What you will see?</h4>
			<ul>
				<li>Simple Menu Setup for Online, Offline and Marketplace billing</li>
				<li> Serve more customers in same time with fastest POS billing</li>
				<li> Effective utilization of stock of raw-materials and perishable items</li>
				<li> Smart reporting to efficiently manage the business, even when you’re away</li>
				<li> Increased customer engagement with repeat business and more referrals</li>
			</ul>
