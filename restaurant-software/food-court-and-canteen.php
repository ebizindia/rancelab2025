...
<head>
	...
	<link rel="canonical" href="<?php echo CONST_APP_ABSURL;?>/restaurant-software/food-court-and-canteen.php"/>
</head>
<body>
...
<section id="hero">
	<div class="hero-container">
		<div class="container">
			<h1 class="text-center">We bring consistency in your service <br>through process automation</h1>
			<h2 class="text-center">We organize your system and bring growth to your business</h2>
...
<!--
	<section class="restaurant_software_container text-center">
		<div class="restaurant_software_banner">
			...
			We bring consistency in your service through process automation<br/>We organize your system and bring growth to your business
			</div>
		</div>
	</section>
