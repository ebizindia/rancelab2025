...
<head>
	...
	<link rel="canonical" href="<?php echo CONST_APP_ABSURL;?>/restaurant-software/quick-service-restaurant-take-away-cafe-pizzeria-ice-cream-shop.php"/>
</head>
<body>
...
<section id="hero">
	<div class="hero-container">
		<div class="container">
			<h1 class="text-center">We speed up your dining service and increase sales <br>We ensure fast service and quick sales</h1>
			<h2 class="text-center">We ensure happy takeaways and repeated / increased sales </h2>
...
<!--
	<section class="restaurant_software_container text-center">
		<div class="restaurant_software_banner">
			...
			We speed up your dining service and increase sales<br/>We ensure fast service and quick sales<br/>We ensure happy takeaways and repeated / increased sales
			</div>
		</div>
	</section>
