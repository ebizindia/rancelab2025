...
<head>
	...
	"postalCode": "700089",
	"streetAddress": "P-240, Lake Town, near Milan Sangha Club"
	},
	...
	<link rel="canonical" href="<?php echo CONST_APP_ABSURL;?>/restaurant-software/sweet-shop-bakery-and-confectionery.php"/>
</head>
<body>
...
<section id="hero">
	<div class="hero-container">
		<div class="container">
			<h1 class="text-center">हम मिठाई और नमकीन की दुकानों को डिजिटली अपग्रेड करते हैं</h1>
			<h2 class="text-center">गल्ले की खनक से आगे की सोच, ERP तक का सफर</h2>
...
<!--
	<section class="restaurant_software_container text-center">
		<div class="restaurant_software_banner">
			...
			We sweeten your customer’s experience<br/>We ensure delightful experience of your customer
			</div>
		</div>
	</section>
...
-->
	...
	$case_studies = [
						...
						[
							'url' => CONST_APP_ABSURL.'/case-studies.php#pantry-dor-bakery-and-cafe',
							'alt_text' => 'Pantry d\'or Bakery & Cafe',
							'img_url' => CONST_APP_ABSURL.'/img/pantry-dor-bakery-and-cafe.jpg',
							'text' => 'Pantry d\'or Bakery & Cafe'
						]
					];
	?>	
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Can you briefly help me understand the product?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "For a single outlet or a chain, RanceLab is a ready‑to‑use software for Restaurant businesses. It takes care of your billing (POS), finance, inventory, customer loyalty, supply chain, payroll, analysis, promotions, and offers. Unlike other software, it makes you profit sooner, reach the break‑even faster, and open new outlets quicker."
      }
    },
    {
      "@type": "Question",
      "name": "Does it support multi location?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "As soon as your organization grows, you will like to have a system that offers 360 degree solutions to your requirements. RanceLab perfectly fits into that and adapts to your business needs and offers modules that scale your business."
      }
    },
    {
      "@type": "Question",
      "name": "Is it available on cloud or desktop?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "RanceLab can be installed and used in various ways that suit your infrastructure. It can be installed on a local machine (desktop or POS) or network of machines. It can be hosted on the cloud and accessed from anywhere."
      }
    },
    {
      "@type": "Question",
      "name": "Does it require the Internet to work?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Desktop software does not require the Internet to function. However, the cloud‑hosted application requires Internet connectivity. You may use your own mobile data to keep the operations running."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "We offer 24/7 support via various support channels such as phone, email, online ticket, web FAQ, online manual, context‑sensitive built‑in help, dedicated support / account managers."
      }
    }
  ]
}
