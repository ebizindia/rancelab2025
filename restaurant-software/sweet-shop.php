...
<head>
    ...
    <link rel="canonical" href="<?php echo CONST_APP_ABSURL;?>/restaurant-software/sweet-shop.php"/>
</head>
<body>
...
<section id="hero">
	<div class="hero-container">
		<div class="container">
			...
			<h2 class="text-center">for Your Sweet Shop </h2>
...
<!--
	<section class="restaurant_software_container text-center">
		<div class="restaurant_software_banner">
			...
			Most Advanced Restaurant Management Software<br/>for Your Sweet Shop
			</div>
		</div>
	</section>
