...
<section id="hero">
	<div class="hero-container">
		<div class="container">
			<h1 class="text-center">Most Advanced Restaurant Management Software <br>for Your Food Court </h1>
...
<!--
	<section class="restaurant_software_container text-center">
		<div class="restaurant_software_banner">
			...
			Most Advanced Restaurant Management Software<br/>for Your Food Court
			</div>
		</div>
	</section>
