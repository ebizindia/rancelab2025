...
<div class="container">
  ...
  <div id="logo" class="pull-left">
    ...
    <a href="/" class="rance_logo"><img src="<?php echo CONST_APP_ABSURL;?>/images/logo.svg" alt="RanceLab" title="RanceLab" width=162 height=34 /></a>
    <!--<a href="/" class="dispmob"><img src="<?php echo CONST_APP_ABSURL;?>/images/logo-mob.png" alt="RanceLab" title="RanceLab" /></a>-->

    <a href="<?php echo CONST_APP_ABSURL;?>/restaurant-software/" class="restaurant_link topblockNav ml-2">Restaurant</a><span class="top_menu_line sepright"></span><a href="<?php echo CONST_APP_ABSURL;?>/retail-software/" class="retail_link topblockNav">Retail</a>
  </div>
  <nav id="nav-menu-container">
    <ul class="nav-menu">
      <li class='<?php if($pagename=="home"){ echo "menu-active"; } ?>'><a href="<?php echo CONST_APP_ABSURL;?>/">Home</a></li>
      <li class='<?php if($pagename=="home"){ echo "menu-active"; } ?>'><a href="<?php echo CONST_APP_ABSURL;?>/about-us.php">About Us</a></li>
      ...
      <li class='menu-has-children <?php if($pagename=="case-studies"){ echo "menu-active"; } ?>'><a href="#">Case Studies</a>
        <ul>
          ...
          <li><a href="<?php echo CONST_APP_ABSURL;?>/testimonials.php">Testimonial</a></li>
          <li><a href="<?php echo CONST_APP_ABSURL;?>/video-testimonials.php">Video Testimonial</a></li>
        </ul>
      </li>
      <li class='menu-has-children <?php if($pagename=="support"){ echo "menu-active"; } ?>'><a href="#">Support</a>
        <ul>
          ...
          <li><a href="<?php echo CONST_APP_ABSURL;?>/faq/" target="_blank">Online FAQ</a></li>
        </ul>
      </li>
